# -*- coding: utf-8 -*-
# Local version
# From Iris-cyy/ZJU-Clock-In & ZJU-nCov-Hitcarder
...
def main(username='*', password='*', cnt=0):
    """Hit card process
    Arguments:
        username: (str) 浙大统一认证平台用户名（一般为学号）
        password: (str) 浙大统一认证平台密码
...
if __name__ == "__main__":
    ...
    scheduler.add_job(main, 'cron', day_of_week='mon-sun', hour=5, minute=30, misfire_grace_time=3600)
    scheduler.start()
    # username = sys.argv[1]
    # password = sys.argv[2]
    # try:
